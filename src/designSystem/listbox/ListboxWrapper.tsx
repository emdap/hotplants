  ...
  return (
    ...
    >
      ...
      >
        <div
          className={classNames(
            "flex gap-4 items-center pl-6 pr-0.5 rounded-t-xl bg-default-background",
            options.length && "border-b border-default-text/20"
          )}
        >
          <input
            name="custom-option"
          ...
          />
          {customOptionInput && (
            <Button variant="text" onClick={saveCustomOption}>
