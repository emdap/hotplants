...
export type SearchPlantsQuery = { plantSearch: { count: number, results: Array<{ scientificName: string, commonNames?: Array<string> | null, mediaUrls: Array<string>, bloomColors?: Array<string> | null, bloomTimes?: Array<string> | null }> } };
