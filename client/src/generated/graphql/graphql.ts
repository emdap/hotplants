...
export type GetSearchRecordPlantCountQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type GetSearchRecordPlantCountQuery = { searchRecordPlantCount: number };
...
export const GetSearchRecordPlantCountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getSearchRecordPlantCount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchRecordPlantCount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<GetSearchRecordPlantCountQuery, GetSearchRecordPlantCountQueryVariables>;